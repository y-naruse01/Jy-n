...
\jtitle{機能的フローネットワークと気象情報を統合した \GCN-\LLM\ Agent による鉄道旅客需要変動の根拠付き説明生成}
\etitle{Grounded Explanation Generation for Railway Passenger Demand Fluctuations Using a \GCN-\LLM\ Agent Integrating Functional Flow Networks and Weather Data}
